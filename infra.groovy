...
node {
    ...
    stage('bootstrap') {
        dir(groovy_scripts_path) {
            sh """
                git clone git@github.com:alainetouches/jenkins-pipeline-groovy.git --branch=master .
            """
        }
        dir(groovy_scripts_path) {
    ...
    stage ('plan') {
        git url: "git@github.com:alainetouches/terraform-aws-ecs-infrastructure.git", branch: "master"
